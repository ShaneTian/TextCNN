...
if __name__ == '__main__':
    ...
    x_train, y_train, vocab_size = data_helper.preprocess("./data/train_data.csv", "./results/vocab.json", args.padding_size)
    train(x_train, y_train, vocab_size, args.padding_size, './results/TextCNN.h5')
